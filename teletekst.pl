...
my %CHARMAP = (
	...
	'Jb0K+c0moOCT6Q8Zf6DPAw' => '?',
	'IkjGweRaGuH6vRPLuY7auA' => '/',
	'p+FeimopKgxSnezUkrwEhg' => '|',
	...
	'UODVaoLlSgTAoTlEk38NVQ' => '#',
	'8SeyFrOE4M59BLaHTyGBNw' => '!',
	'lBDIjP1BWu6KbfKIBV9L7g' => '$',
	'lbrIheu9c8hZdQhDOqJlDA' => '<',
	'wRKh3s+dPqm94vFPUldg+w' => '>',
	'tNTq1vPzpo//u3gNSVh+8Q' => "\x{b0}", # °
	...
	'IGv6LQ8Xp7+rbrCmenh9Jw' => '(',
	'xZc0ULYEPq78fArITsAV+A' => ')',
	'MmP+VsOr6lhkmWkvT0IN5g' => '&',
	'X/lNc2s8C9kLp2QUyLl8jQ' => "\x{dc}", # Ü
	'mQRHPzWxwvgQ3sBGHwZR8w' => "\x{e1}", # á
	'y7PYFCyqQB2QjSTHAuB+1Q' => "\x{e3}", # ã
	...
	'rQPD3nGIbU8YCPvUKmCMOg' => "\x{ef}", # ï
	'7A8Uq+EqAsnHVLKrp+vavg' => "\x{d6}", # Ö
	...
	'boFuUnTzFtiulMWUiDM3hg' => ' ', # ;
	'1Aui/fKrolwZLYhvxmQyVQ' => ' ', # # (inverse)
	'0yUYv/CW91hK6Gy7Hl/CXA' => ' ', # /
	'24GbrUDu0h2AlS/HwYtK9A' => ' ', # %
	'emzvbGCPWxlKC00KCoYv3A' => ' ', # & (inverse)
	'I5q7IGZYpg4u0NEFiTi+pw' => ' ', # ç
	'AF0EEXLWbDFDEaGfB3cLtw' => ' ', # (
	'mrIfk8Vl7G9PrrqqhfmY2g' => ' ', # )
);
